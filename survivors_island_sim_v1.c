...
int main() {
    ...
    while (player.level <= 3) {
        ...
        printf("2. Gather wood\n");
        printf("3. Explore West\n");
        printf("4. Gather water\n");
    ...
    if (player.level > 3) {
        printf("Congratulations! You have completed all levels and survived on the island!\n");
    }
...
void exploreNorth(Player *player) {
    ...
    if (event == 0) {
        printf("You find some wood.\n");
        player->wood += 10;
    } else if (event == 1) {
        printf("You find a river and gather water.\n");
        player->water += 5;
    } else if (event == 2) {
        printf("You encounter a wild animal and lose 10 health.\n");
        player->health -= 10;
    } else {
        printf("You find a healing pack! Your health is restored to 100.\n");
